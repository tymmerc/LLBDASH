                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    if (!empty($categories)) {
                                        foreach ($categories as $category) {
                                            ...
                                            $percentage = min($category['PopularCategories'], 173);
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">En construction ...</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <ul class="list-group">
                                        ...
                                        foreach ($posts as $post) {
                                            ...
                                            echo '<a href="' . $postLink . '" class="text-decoration-none">' . htmlspecialchars($post['post_title']) . '</a>';
